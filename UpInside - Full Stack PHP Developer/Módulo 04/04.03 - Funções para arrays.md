...
// Adiciona uma posição no início do array "index"
array_unshift($arrayIndex, "Teste A", "Teste B");
// Adiciona uma posição no final do array "index"
array_push($arrayIndex, "Teste C");

// Adiciona uma posição no início do array "associativo"
$arrayAssoc = ['Assoc 0' => 'Conteúdo 0'] + $arrayAssoc;
// Adiciona uma posição no final do array "associativo"
...
// Inverte a ordem das posições do array e mantém cada chave com seu valor
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjMxNDYzMDI2XX0=
-->